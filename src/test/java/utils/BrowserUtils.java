...
public class BrowserUtils {
    ...
    public static String takeScreenshot(){
        ...
        // file location for our current project, coming from java, not depends on local pc

        // currentTimeMillis, file, System ..coming from java
        // TakeScreenshot,getDriver, getScreenshotAs coming from selenium
    ...
    //then we need to connect this screenshot action to our EtsySearchStep @AfterMethod annotation
